...
-- MAGIC %md
-- MAGIC ## Electronics Retail Company, "Initech", with brick & mortar locations as well as an online marketplace
...
-- MAGIC * Online sales growing, but at a slower rate than Amazon and others. Only ~2% YoY, they are looking to grow ~8-10% YoY
...
-- MAGIC * Data in many diffrent systems, DBs, ERPs, etc
-- MAGIC * KPIs, BI & Reports are stale - Takes days for ELT
...
-- MAGIC %md 
-- MAGIC ####Azure Databricks is Unified Analytics Platform for Data Engineers, Data Scientist, and Analysis  
-- MAGIC 
...
-- MAGIC * Financial Services: Alternitive data, Credit Risk, ATM/CC Fraud Detection
