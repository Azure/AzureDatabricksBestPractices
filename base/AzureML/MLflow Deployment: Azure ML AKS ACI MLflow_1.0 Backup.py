...
# MAGIC   - `mlflow` - if you want to always use the latest, else use syntax `mlflow=1.5.0` to get a dedicated version of MLflow
# MAGIC   
# MAGIC 2. Attach the library to the cluster.

# COMMAND ----------

# MAGIC %md ### Install the Azure ML MLflow SDK
# MAGIC 
