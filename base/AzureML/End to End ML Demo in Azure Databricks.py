...
# MAGIC   
# MAGIC - Use a DBR with Python 3, this notebook is demoed with DBR 6.5
...
# MAGIC   - `mlflow` - if you want to always use the latest, else use syntax `mlflow=1.7.0` to get a dedicated version of MLflow
# MAGIC   
