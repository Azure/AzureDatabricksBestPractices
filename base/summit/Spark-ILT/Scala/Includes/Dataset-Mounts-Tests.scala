...
testRegion("AWS", "ap-northeast-1", getAwsMapping _)
...
def doubleCheck(region:String):Unit = {
  assert(regions.contains(region), s"Missing $region")
}
doubleCheck("us-west-2")
doubleCheck("ap-northeast-1")
doubleCheck("ap-northeast-2")
doubleCheck("ap-south-1")
doubleCheck("ap-southeast-1")
doubleCheck("ap-southeast-2")
doubleCheck("ca-central-1")
doubleCheck("eu-central-1")
doubleCheck("eu-west-1")
doubleCheck("eu-west-2")
doubleCheck("eu-west-3")
doubleCheck("sa-east-1")
doubleCheck("us-east-1")
doubleCheck("us-east-2")
doubleCheck("eastasia")
doubleCheck("eastus")
doubleCheck("eastus2")
doubleCheck("northcentralus")
doubleCheck("northeurope")
doubleCheck("southcentralus")
doubleCheck("southeastasia")
doubleCheck("westeurope")
doubleCheck("westus")
doubleCheck("westus2")
