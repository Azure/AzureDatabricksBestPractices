...
# MAGIC 
# MAGIC MLflow is an open source software project developed by Databricks available to developers regardless of which platform they are using.  Databricks hosts MLflow for you, which reduces deployment configuration and adds security benefits.  As of February 2019,  <a href="https://docs.databricks.com/release-notes/release-types.html" target="_blank">MLflow is in public preview</a> and is therefore accessible on all Databricks workspaces.
# MAGIC 
...
# MAGIC %md-sandbox
# MAGIC MLflow has number of dependencies, which have been installed for you for this class.  If you are running this code on a different cluster from what has been provisioned for you, uncomment and run the following code to install these libraries:<br><br>
# MAGIC 
# MAGIC  - mlflow==0.9.0
...
# MAGIC 2. The artifact location.  This is where the artificats are stored in DBFS, which is backed by the Azure blob store
