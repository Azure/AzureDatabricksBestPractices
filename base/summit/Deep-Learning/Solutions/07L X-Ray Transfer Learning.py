...
lr = LogisticRegression(maxIter=30, regParam=0.10, elasticNetParam=0.3, labelCol="label")
...
accuracy = round(evaluator.evaluate(pred_df.select("prediction", "label"))*100, 2)
