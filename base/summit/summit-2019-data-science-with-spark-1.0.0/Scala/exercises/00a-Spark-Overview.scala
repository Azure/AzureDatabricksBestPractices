...
// MAGIC %md-sandbox
// MAGIC ##![Spark Logo Tiny](https://files.training.databricks.com/images/105/logo_spark_tiny.png) Local Mode & Databricks CE
// MAGIC 
// MAGIC One option, commonly used for local development, is to run Spark in **Local Mode**.
// MAGIC * In **Local Mode**, both the **Driver** and one **Executor** share the same JVM.
// MAGIC * This is an ideal scenario for experimentation, prototyping, and learning!
// MAGIC * Databricks also offers a free version of its hosted platform called the **Community Edition**.
// MAGIC * The **Community Edition** of Databricks hosted solution runs in **Local Mode**.
// MAGIC * Paired with the power of their online notebooks, we have a nice platform for training and prototyping.
// MAGIC 
// MAGIC <img src="https://files.training.databricks.com/images/databricks-ce-arch.png"/>

// COMMAND ----------

// MAGIC %md-sandbox
// MAGIC 
// MAGIC ##![Spark Logo Tiny](https://files.training.databricks.com/images/105/logo_spark_tiny.png) Multiplexing Databricks CE
// MAGIC 
// MAGIC * The **Community Edition** version of Databricks is also multitenant.
// MAGIC   * More people get to try out Databricks & Apache Spark
// MAGIC   * We have to share with 8-9 other users
// MAGIC   * The CE's performance is not representative of a production cluster
// MAGIC * Technically, it looks a little bit more like this:
// MAGIC 
// MAGIC <img src="https://files.training.databricks.com/images/databricks-ce-multiplexed.png" alt="Notebook + Micro Cluster + Multitenant">
