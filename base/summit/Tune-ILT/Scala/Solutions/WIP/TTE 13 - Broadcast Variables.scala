...
var names = spark.read.parquet("dbfs:/mnt/training/ssn/names.parquet")
var people = (
  spark
    .read
    .option("delimiter", ":")
...
var joinedDF = names.join(people, "firstName")
...
var joinedDF2 = names.join(broadcast(people), "firstName")
