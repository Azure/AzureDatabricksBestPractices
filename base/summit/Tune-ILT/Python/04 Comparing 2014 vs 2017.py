...
schema2014 = "transacted_at timestamp, trx_id integer, retailer_id integer, description string, amount decimal(38,18), city_id integer, year integer, month integer"

# The "slow" version of the 2014 dataset
path2014 = "/mnt/training/global-sales/transactions/2014.parquet"
trx2014DF = spark.read.schema(schema2014).parquet(path2014)

# The "fast" version of the 2014 dataset
fastPath14 = "/mnt/training/global-sales/solutions/2014-fast.parquet"
fast2014DF = spark.read.schema(schema2014).parquet(fastPath14)
...
schema2017 = "transacted_at timestamp, trx_id integer, retailer_id integer, description string, amount decimal(38,18), city_id integer"

#  The "slow" version of the 2017 dataset
path2017 = "/mnt/training/global-sales/transactions/2017.parquet"
trx2017DF = spark.read.schema(schema2017).parquet(path2017)

# The "fast" version of the 2017 dataset
fastPath17 = "/mnt/training/global-sales/solutions/2017-fast.parquet"
fast2017DF = spark.read.schema(schema2017).parquet(fastPath17)
...
bothYearsDF = byMonth2014DF.unionByName(byMonth2017DF)
...
holiday14DF = (fast2014DF // trx2014DF
  ...
  .FILL_IN  # extract the day of year from transacted_at
  .FILL_IN  # aggregate by year and day
  .FILL_IN  # sum up all transactions
  .FILL_IN  # rename the aggregate value 
  .FILL_IN  # sort by the day of year
)
