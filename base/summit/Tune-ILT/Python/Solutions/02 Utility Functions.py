...
path = "dbfs:/mnt/training/asa/flights/all-by-year"
...
bonusPath = "dbfs:/mnt/training/asa/flights/1990-1999-by-year.parquet"
(bonusCount, bonusBytes) = computeFileStats(bonusPath)

print("{:,} files".format(bonusCount))
print("{:,} bytes".format(bonusBytes))
print("-"*80)
...
(dfB, total, duration) = benchmarkCount(lambda: dfA)
