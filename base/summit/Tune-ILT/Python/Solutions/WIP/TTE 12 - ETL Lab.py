...
df1Out = df1.filter("ssn != 555555555")
df2Out = df2.filter("ssn != 555555555")
df1In = df1.filter("ssn = 555555555")
df2In = df2.filter("ssn = 555555555")

# COMMAND ----------

# ANSWER
dfOutJoined = df1Out.join(df2Out, ("ssn"))
dfInJoined = df1In.join(broadcast(df2In), ("ssn"))
dfJoined2 = dfOutJoined.union(dfInJoined)
