...
def ResNet(input_shape=None, classes=10, block='bottleneck', residual_unit='v2', repetitions=None,
           initial_filters=64, activation='softmax', include_top=False, input_tensor=None, dropout=None,
    ...
    x = AveragePooling2D(pool_size=(block_shape[ROW_AXIS], block_shape[COL_AXIS]),
                         strides=(1, 1))(x)
    x = Flatten()(x)
