...
# MAGIC %sql
# MAGIC cache table cms_2015;
# MAGIC cache table cms_unit_price;

# COMMAND ----------

# MAGIC %md
# MAGIC Basic statistics to understand the dataset first 

# COMMAND ----------

# MAGIC %sql
# MAGIC desc extended cms_2015
...
# MAGIC %sql 
# MAGIC -- Name of brand / specific drug. In this case Levemir Victoza is a brand of insulin 
# MAGIC select 
# MAGIC   Name_of_Associated_Covered_Drug_or_Biological1, 
# MAGIC   Name_of_Associated_Covered_Drug_or_Biological2, 
# MAGIC   NDC_of_Associated_Covered_Drug_or_Biological2 
# MAGIC   from cms_2015 
# MAGIC   where NDC_of_Associated_Covered_Drug_or_Biological2 = "0169-4060-90"

# COMMAND ----------

# MAGIC %md
# MAGIC ### Load fraud dataset 

# COMMAND ----------

from pyspark.sql.functions import * 

df = spark.read.options(header="true", inferSchema="true").csv("/mnt/mwc/cms/2015-fraud").\
...
# accuracy of the decision tree model v1.0 
cvPredictions = cvModel.transform(testData)
evaluator.evaluate(cvPredictions)
...
# MAGIC %sql
# MAGIC select convert_human_readable(sum(avg_unit_price_raw)) as total_claimed, sum(avg_unit_price_raw) as total_raw , state, fraud_reported, count(1) as num_of_claims
# MAGIC   from cms_fraud a
# MAGIC   join cms_unit_price b 
# MAGIC   on a.drug_id = b.drug_id 
# MAGIC   group by fraud_reported, state
