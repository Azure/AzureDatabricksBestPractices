...
# MAGIC 
# MAGIC ![Databricks Medicare FPS Analytics](http://wrcb.images.worldnow.com/images/7355958_G.jpg "Databricks Medicare FPS")  
...
df = spark.read.options(header="true", inferSchema="true").csv("/mnt/wesley/dataset/medicare/fraud/cms/2015-fraud").\
...
spark.read.parquet("/mnt/wesley/dataset/medicare/fraud/cms_p/2015").createOrReplaceTempView("cms_2015")
spark.read.parquet("/mnt/wesley/dataset/medicare/fraud/cms_2015_unit_price").createOrReplaceTempView("cms_unit_price")
df = spark.read.parquet("/mnt/wesley/dataset/medicare/fraud/cms/2015-fraud-p")
