...
# MAGIC <img src="http://static.lakana.com/nxsglobal/fox16/photo/2017/05/02/Opioid%20Epidemic_1493737557054_20542003_ver1.0_640_360.PNG" width="20%" style="float: left; margin-right: 30px;">
...
opioids = (
  spark.read
    ...
    .option("header", "true")
    .csv("dbfs:/FileStore/tables/lyd6k0x21507578547527/opioids.csv")
)
...
overdoses = (
  spark.read
    ...
    .option("inferSchema", "true")  # Use tab delimiter (default is comma-separator)
    .option("header", "true")
    .csv("dbfs:/FileStore/tables/lyd6k0x21507578547527/overdoses.csv")
)
...
prescriber_info = (
  ...
  .option("inferSchema", "true")  # Use tab delimiter (default is comma-separator)
   .option("header", "true")
  .csv("dbfs:/FileStore/tables/k2b1szxn1507457692619/prescriber_info-b6d97.csv")
)
...
prescriber_info_detail = (
  spark.read
    ...
    .csv("dbfs:/FileStore/tables/z3jndpd51507444975197/prescriber_info_new1-4031d.csv")
)
