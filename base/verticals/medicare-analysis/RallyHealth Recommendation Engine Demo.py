...
# MAGIC %fs ls /mnt/wesley/dataset/medicare/recomendation
...
quotedf = (sqlContext.read.format('com.databricks.spark.xml').options(rowTag='Plan').load('/mnt/wesley/dataset/medicare/recomendation/HealthPlan.xml'))
clientdf = (sqlContext.read.format('com.databricks.spark.xml').options(rowTag='user').load('/mnt/wesley/dataset/medicare/recomendation/quote2.xml'))
