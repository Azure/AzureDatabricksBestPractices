...
# MAGIC %fs cp -r file:/tmp/ml-1m/ dbfs:/movielens1m
...
# MAGIC %fs head dbfs:/movielens1m/users.dat
...
# MAGIC )
# MAGIC LOCATION 
# MAGIC   'dbfs:/movielens1m/users*.dat'
...
# MAGIC %fs head dbfs:/movielens1m/ratings.dat
...
ratings = sc.textFile("dbfs:/movielens1m/ratings.dat").map(create_row_for_rating)
...
# MAGIC %fs head dbfs:/movielens1m/movies.dat
...
movies = sc.textFile("dbfs:/movielens1m/movies.dat").map(create_row)
